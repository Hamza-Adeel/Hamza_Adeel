      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <ScrollReveal direction="up" delay={0.2}>
            <form className="grid grid-cols-1 md:grid-cols-2 flex-wrap gap-6" onSubmit={(e) => e.preventDefault()}>
              {/* Name */}
              <input
                type="text"
                placeholder="Name"
                className="w-full rounded-md border border-green-700 bg-black/40 px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 text-white placeholder-gray-500"
              />
              ...
              {/* Service of Interest */}
              <select
                className="w-full rounded-md border border-green-700 bg-black/40 px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 text-white"
                defaultValue=""
              >
              ...
              <textarea
                ...
                className="w-full rounded-md border border-green-700 bg-black/40 px-3 py-2 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 text-white placeholder-gray-500 h-28 md:col-span-2"
              />
